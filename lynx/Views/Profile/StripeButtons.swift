...
//  lynx
//
//  Created by Arnav Wadehra on 6/28/22.
//
...
struct ConfirmAmount: View {
    var body: some View {
        HStack {
            Text("CONFIRM AMOUNT").fontWeight(.bold)
        }
        .frame(minWidth: 200)
        .padding()
        .foregroundColor(.white)
        ...
        .cornerRadius(6)
        .accessibility(identifier: "Create button")
    }
}
